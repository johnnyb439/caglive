    ...
    return (
      <div className="bg-white dark:bg-[#1a1a1a] rounded-lg shadow-sm dark:shadow-gray-800 p-6">
        <div className="flex items-center space-x-3 mb-4">
          ...
          <h3 className="text-xl font-semibold text-gray-900 dark:text-white">Resume-to-Job Matcher</h3>
        </div>
        <div className="flex items-center justify-center py-12">
          <div className="text-center">
            <div className="animate-spin rounded-full h-12 w-12 border-b-2 border-blue-600 mx-auto mb-4"></div>
            <p className="text-gray-600 dark:text-gray-400">Finding matching jobs...</p>
          </div>
        </div>
      </div>
    )
      ...
      <div className="space-y-4">
        {displayedMatches.map((job, index) => (
          <motion.div
            ...
            className="border border-gray-200 dark:border-gray-700 rounded-lg p-4 hover:border-gray-300 dark:hover:border-gray-600 transition-all"
          >
