        ...
        {currentResume ? (
          <div className="space-y-4">
            <div className="flex items-center justify-between p-4 bg-gray-50 dark:bg-[#2a2a2a] rounded-lg">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <p className="font-medium text-gray-900 dark:text-white">{currentResume.name}</p>
          ...
          <div
            ...
            className={`
              ...
              ${isDragging ? 'border-blue-500 bg-blue-50 dark:bg-blue-900/20' : 'border-gray-300 dark:border-gray-600 bg-gray-50 dark:bg-[#2a2a2a]'}
          ...
          >
            ...
            <label htmlFor="resume-upload" className="cursor-pointer">
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400">
                Drag and drop or <span className="text-blue-600 dark:text-blue-400 hover:underline">browse</span>
              </p>
            ...
            {isUploading && (
              <div className="absolute inset-0 flex items-center justify-center bg-white dark:bg-[#1a1a1a] bg-opacity-90 dark:bg-opacity-90 rounded-lg">
        ...
        {showDeleteModal && (
          ...
          >
            <motion.div
              ...
              className="bg-white dark:bg-[#1a1a1a] rounded-lg shadow-xl p-6 max-w-md w-full"
            >
              <div className="flex items-center space-x-3 mb-4">
                <div className="flex-shrink-0 w-12 h-12 bg-red-100 rounded-full flex items-center justify-center">
                  <Trash2 className="w-6 h-6 text-red-600" />
                </div>
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white">Delete Resume</h3>
              </div>
              ...
              <div className="flex space-x-3">
                <button
                  ...
                  className="flex-1 px-4 py-2 border border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 rounded-lg hover:bg-gray-50 dark:hover:bg-[#2a2a2a] transition-colors"
                >
                  Cancel
                </button>
                <button
